...
The Herdr adapter implements this contract for live terminal agents. The shared filesystem remains the universal transport; an offline agent checks its inbox at startup or resume.
